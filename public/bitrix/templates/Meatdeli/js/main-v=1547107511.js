$(document).ready(function () {
  ...
  //   $('.block-recipe .container-w .lastest').append(
  //     '<div id="filtertool"></div>'
  //   );
  ...
  //       e.stopPropagation();
  //       if (
  //         !$(this).closest('.selectbox').hasClass('no-select') &&
  //         !$(this).hasClass('sub')
  //       ) {
  ...
  //           $('.filterProductBox .filterCat .catProduct' + id).addClass(
  //             'active'
  //           );
  //           $('.filterProductBox .filterCat .catProduct' + id + ' .cat')
  //             .first()
  //             .addClass('active');
  //           $('.filterProductBox .filterCat .catProduct' + id + ' .cat')
  //             .first()
  ...
  //             .first()
  //             .addClass('active');
  //           $('.filterProductBox .filterCatMobile .catProduct').removeClass(
  //             'active'
  //           );
  //           $('.filterProductBox .filterCatMobile .catProduct' + id).addClass(
  //             'active'
  //           );
  //           var pdfirst = $(
  //             '.filterProductBox .filterCatMobile .catProduct.active ul li'
  //           )
  //             .first()
  //             .text();
  //           $(
  //             '.filterProductBox .filterCatMobile .catProduct.active .head .inner span'
  //           ).html(pdfirst);
  //         }
  //         SelectBox.selectBoxDisableAll();
  //       } else {
  ...
  $(window).load(function () {
    objectFitImages();
    var isMobile = /Android|iPhone|iPod|BlackBerry|Windows Phone/g.test(
